...
namespace RegisterService_L
{
    ...
    public class Service1 : IService4
    {
        ...
        */
        ...
        public DataSet querySql(out bool queryParam, string userid, string password)
        {
            try
            {
                ...
                sqlCon.Open();
                string strSql = "insert into info(userid,password) VALUES ('" + userid + "','" + password + "')";
